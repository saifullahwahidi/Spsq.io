...

{
        ...
        socket.onmessage = (event) => {
          ...
          if (data.table === 'instrument') {
            ...
            if (fundingRateObj && fundingRateObj.fundingRate){
              ...
              const fundingRateElement = document.getElementById('bitmex__Funding_rate');
      ...
      function getFundingRate(symbol) {
          ...
          fetch(apiEndpoint)
            ...
            .then(data => {
              ...
              let fundingRateElement = document.getElementById("bitmex__Funding_rate2");
        ...
        function getFundingRate(symbol) {
            ...
            fetch(apiEndpoint)
              ...
              .then(data => {
                ...
                let fundingRateElement = document.getElementById("funding_rate_binancep");
        ...
        function getFundingRate(symbol) {
            ...
            fetch(apiEndpoint)
              ...
              .then(data => {
                ...
                console.log(data)
                let fundingRateElement = document.getElementById("funding_rate_binancef");
    ...
    const url = 'https://api.bybit.com/v2/public/funding/prev-funding-rate?symbol=BTCUSD&exchange=BYBIT';
    
    fetch(url)
      .then(response => response.json())
      .then(data => {
        const fundingRate = data.result.funding_rate;
        document.getElementById('Bybit__BTC_Funding').textContent = ` ${fundingRate}%`;
      })
      .catch(error => console.error(error));
    ...
    fetch(`${baseUrl}/v2/public/tickers?symbol=${symbol}`)
      ...
      .then(data => {
        ...
        document.getElementById("bybit_btcusdt_funding_rate").innerHTML=symbolInfo
      })
      .catch(error => {
      ...
      function getFundingRate(symbol) {
          ...
          fetch(apiEndpoint)
            ...
            .then(data => {
              ...
              let fundingRateElement = document.getElementById("Okex_BTC__Funding_rate_F");
        ...
        function getFundingRate(symbol) {
            ...
            fetch(apiEndpoint)
              ...
              .then(data => {
                ...
                let fundingRateElement = document.getElementById("Okex_BTC__Funding_rate_P");
